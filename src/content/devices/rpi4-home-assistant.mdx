...
year: 2022
showcase:
  heroEyebrow: "Home Automation"
  heroTagline: "Lokal. Ohne Cloud. Ohne Kompromisse."
  bigStatement:
    value: "100%"
    label: "Lokal ausgeführt — kein Cloud-Server nötig."
    eyebrow: "Lokale Kontrolle"
    facts:
      - value: "100%"
        subtext: "Alle Automationen lokal — kein Internet nötig"
      - value: "Zigbee"
        subtext: "Lokaler Koordinator statt Cloud-abhängiger Bridge"
      - value: "24/7"
        subtext: "Dedizierte Hardware — kein Mischbetrieb"
---

import Section from '../../components/device/common/Section.astro'
import HomeDiagram from '../../components/device/unique/rpi4-home-assistant/HomeDiagram.astro'

<Section eyebrow="IoT-Netzwerk" heading="Geräte-Übersicht" id="diagram" wide centered>
