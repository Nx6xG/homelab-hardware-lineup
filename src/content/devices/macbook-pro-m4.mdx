...
year: 2024
showcase:
  heroEyebrow: "Apple Silicon"
  heroTagline: "Entwicklung. Homelab-Kontrolle. Alles."
  bigStatement:
    value: "12"
    label: "CPU-Kerne. Nativ. Kein Overhead."
    eyebrow: "Apple M4 Pro"
    facts:
      - value: "12"
        subtext: "CPU-Kerne — 8 Performance + 4 Effizienz-Kerne"
      - value: "Arm64"
        subtext: "Native Docker-Images — kein Emulations-Overhead"
      - value: "5 Hosts"
        subtext: "SSH-Zugriff auf alle Lab-Geräte per Alias"
---

import Section from '../../components/device/common/Section.astro'
import SSHNetwork from '../../components/device/unique/macbook-pro-m4/SSHNetwork.astro'

<Section eyebrow="SSH-Kontrolle" heading="Netzwerk-Verbindungen" id="ssh" wide centered>
